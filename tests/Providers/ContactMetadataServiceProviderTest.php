...
class ContactMetadataServiceProviderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service_provider = new ContactMetadataServiceProvider($this->application_mock);
    ...
    {
        $this->assertContains('Mailjet\LaravelMailjet\Contracts\ContactMetadataContract', $this->service_provider->provides());
    }
