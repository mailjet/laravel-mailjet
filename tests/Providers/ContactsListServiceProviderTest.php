...
class ContactsListServiceProviderTest extends TestCase
{
    /**
     * @var Mockery\Mock
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->service_provider = new ContactsListServiceProvider($this->application_mock);
    ...
    {
        $this->assertContains('Mailjet\LaravelMailjet\Contracts\ContactsListContract', $this->service_provider->provides());
    }
