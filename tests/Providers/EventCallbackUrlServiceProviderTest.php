...
class EventCallbackUrlServiceProviderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service_provider = new EventCallbackUrlServiceProvider($this->application_mock);
    ...
    {
        $this->assertContains('Mailjet\LaravelMailjet\Contracts\EventCallbackUrlContract', $this->service_provider->provides());
    }
